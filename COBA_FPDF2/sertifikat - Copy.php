...
$query ="SELECT skor.*, data_koperasi.nama_koperasi  FROM skor
			LEFT JOIN data_koperasi ON skor.kd_koperasi=data_koperasi.kd_koperasi
			WHERE data_koperasi.kd_koperasi='$Kode'";
...
$pdf->Cell(0,0.5,'HASIL PENILAIAN TINGKAT KESEHATAN',0,1,'C');
$pdf->Cell(0,0.5,'(KSP) KOPERASI SIMPAN PINJAM / (USP) UNIT SIMPAN PINJAM',0,1,'C');
...
$pdf->Ln();
$pdf->Cell(1,0.5,'','',0,'L');
$pdf->Cell(5.3,0.5,'Nama Koperasi','',0,'L');
$pdf->Cell(0.2,0.5,':','',0,'L');
$pdf->SetFont('Arial','B',11);
$pdf->Cell(1.1,0.5,$cell[3],'',0,'L');
$pdf->Cell(0,0.5,'"'.$cell[13].'"','',0,'L');
$pdf->Ln();
$pdf->SetFont('Arial','',11);
#$pdf->Cell(6,0.7,$cell[3],'LBTR',0,'L');
#$pdf->Ln();
$pdf->Cell(1,0.5,'','',0,'L');
$pdf->Cell(5.3,0.6,'Badan Hukum','',0,'L');
...
$pdf->Cell(1,0.5,'','',0,'L');
$pdf->Cell(5.3,0.6,'Penilaian Kesehatan','',0,'L');
$pdf->Cell(0.2,0.6,':','',0,'L');
$pdf->Cell(2.2,0.6,'Tahun Buku','',0,'L');
$pdf->Cell(0,0.6,$cell[7],'',0,'L');
$pdf->Ln();
$pdf->Cell(1,0.5,'','',0,'L');
$pdf->Cell(5.3,0.6,'Score','',0,'L');
$pdf->Cell(0.2,0.6,':','',0,'L');
$pdf->Cell(0.9,0.6,$cell[9],'',0,'L');
$pdf->Cell(0,0.6,'"'.$cell[10].'"','',0,'L');
$pdf->Ln();


$pdf->Cell(1,0.5,'','',0,'L');
$pdf->Cell(5.3,0.6,'Predikat','',0,'L');
$pdf->Cell(0.2,0.6,':','',0,'L');
$pdf->SetFont('Arial','B',11);
$pdf->Cell(0,0.6,$cell[11],'',0,'L');
$pdf->Ln();
$pdf->Ln();
$pdf->Ln();
...
$pdf->Cell(5,0.4,'','',0,'C');
$pdf->SetFont('Arial','b',11);
$pdf->Cell(0,0.4,'DRA. LITANI SATYAWATI','',0,'C');
$pdf->Ln();
$pdf->SetFont('Arial','',11);
$pdf->Cell(5,0.5,'','',0,'C');
