...
$query ="SELECT * from kecamatan ORDER BY kd_kecamatan ASC";
...
$pdf->Cell(0,0.5,'LAPORAN DATA KECAMATAN ',0,1,'C');
$pdf->Cell(0,0.5,'SEKOTA SEMARANG ',0,1,'C');
...
$pdf->Cell(3,0.7,'KODE KECAMATAN','LRTB',0,'C');
$pdf->Cell(15,0.7,'NAMA KECAMATAN','LRTB',0,'L');
