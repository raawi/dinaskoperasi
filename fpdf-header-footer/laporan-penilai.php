...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(20);
		//judul
		$this->Cell(0,7,'LAPORAN DATA PENILAI KESEHATAN KOPERASI',0,0,'L');
		$this->Ln();
		$this->Cell(20);
...
$this->Cell(51,7,'NIP','LRTB',0,'L');
$this->Cell(42,7,'NAMA','LRTB',0,'L');
$this->Cell(95,7,'USERNAME','LRTB',0,'L');
