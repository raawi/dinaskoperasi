...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(20);
		//judul
		$this->Cell(0,7,'LAPORAN DATA BENTUK KOPERASI',0,0,'L');
		$this->Ln();
		$this->Cell(20);
...
$this->Cell(51,7,'Kode Bentuk Koperasi','LRTB',0,'L');
$this->Cell(42,7,'Bentuk Koperasi','LRTB',0,'L');
$this->Cell(95,7,'Kepanjangan','LRTB',0,'L');
...
$query ="SELECT * FROM bentuk_koperasi";
...
$this->Cell(42,7,$cell[$j][1],'LBTR',0,'L');
$this->Cell(95,7,$cell[$j][2],'LBTR',0,'L');
$this->Ln();
