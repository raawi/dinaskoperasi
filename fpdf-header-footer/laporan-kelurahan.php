...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(20);
		//judul
		$this->Cell(0,7,'LAPORAN DATA KELURAHAN KOTA SEMARANG',0,0,'L');
		$this->Ln();
		$this->Cell(20);
...
$this->Cell(51,7,'Kode Kelurahan','LRTB',0,'L');
$this->Cell(51,7,'Kecamatan','LRTB',0,'L');
$this->Cell(86,7,'Nama Kelurahan','LRTB',0,'L');
...
$query ="SELECT kelurahan.*, kecamatan.nama_kecamatan FROM kelurahan
...
$this->Cell(51,7,$cell[$j][2],'LTB',0,'L');
$this->Cell(86,7,$cell[$j][1],'LBTR',0,'L');
$this->Ln();
...
$pdf->AddPage();
$pdf->Content();
$namafile = 'Data Kelurahan '.$tgl.'.pdf';
